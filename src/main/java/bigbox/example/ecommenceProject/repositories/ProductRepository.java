...
public interface ProductRepository extends JpaRepository<Product, Integer> {
    ...
    Page<Product> getBySubCategory_Category_CategoryId(int categoryId, Double minPrice, Double maxPrice, String orderBy, Pageable pageable);
    ...
    @Query("SELECT p FROM Product p " +
            ...
            "ORDER BY CASE WHEN :orderBy = 'ASC' THEN p.productPrice END ASC, " +
            "CASE WHEN :orderBy = 'DESC' THEN p.productPrice END DESC")
    Page<Product> getBySubCategory_Category_CategoryIdAndSubCategory_SubCategoryId(int categoryId, int subCategoryId, Double minPrice, Double maxPrice, String orderBy, Pageable pageable);
    ...
    @Query("SELECT p FROM Product p " +
            ...
            "ORDER BY CASE WHEN :orderBy = 'ASC' THEN p.productPrice END ASC, " +
            "CASE WHEN :orderBy = 'DESC' THEN p.productPrice END DESC")
    Page<Product> getByProductNameContains(String keyword, Double minPrice, Double maxPrice, String orderBy, Pageable pageable);
    ...
    @Query("SELECT p FROM Product p " +
            ...
            "ORDER BY CASE WHEN :orderBy = 'ASC' THEN p.productPrice END ASC, " +
            "CASE WHEN :orderBy = 'DESC' THEN p.productPrice END DESC")
    Page<Product> findProductsByProductPriceRange(Double minPrice, Double maxPrice, String orderBy, Pageable pageable);
